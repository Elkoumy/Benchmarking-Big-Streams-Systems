...
#
##Create Kafka topic
#./bin/kafka-topics.sh --delete --zookeeper zookeeper-node01:2181 --topic ad-events
#./bin/kafka-topics.sh --create --zookeeper zookeeper-node01:2181 --replication-factor 1 --partitions 100 --topic ad-events
#./bin/kafka-topics.sh --create --zookeeper zookeeper-node01:2181 --replication-factor 1 --partitions 4 --topic sample-test
#
#./bin/kafka-topics.sh --create --zookeeper zookeeper-node01:2181 --replication-factor 1 --partitions 1 --topic ad-events
#./bin/kafka-topics.sh --delete --zookeeper zookeeper-node01:2181 --topic ad-events
#
##Producer
